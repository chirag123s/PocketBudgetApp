...
interface Slide {
  ...
  title: string;
  description: string;
  gradientColors: (theme: ReturnType<typeof getTheme>) => string[];
}
...
const slides: Slide[] = [
  {
    ...
    gradientColors: (theme) => [theme.colors.primary[400], theme.colors.primary[600]],
  },
  {
    icon: 'wallet',
    emoji: '💰',
    ...
    gradientColors: (theme) => [theme.colors.info.light, theme.colors.info.main],
  },
  {
    icon: 'trending-up',
    emoji: '📊',
    ...
    gradientColors: (theme) => [theme.colors.accent.light, theme.colors.accent.main],
  },
  {
    icon: 'notifications',
    emoji: '⏰',
    ...
    gradientColors: (theme) => [theme.colors.warning.light, theme.colors.warning.main],
  },
];
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.illustrationContainer}>
            <LinearGradient
              colors={currentSlideData.gradientColors(theme)}
